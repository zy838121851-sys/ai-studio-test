...
- `styles/features/node.css` now owns image lightbox styles, stack/folded node
  styles, director node styles, image/video/model media node preview styles,
