...
const EXPECTED_NODE_DIRECTOR_TILE_IMPORTS = [
  "./node-director-tile-shell.css",
  "./node-director-tile-state.css",
  "./node-director-tile-content.css"
];
...
const EXPECTED_HOME_RESPONSIVE_MOBILE_IMPORTS = [
  ...
  "./home-responsive-mobile-feed.css",
  "./home-responsive-mobile-prompt.css"
];
...
const EXPECTED_HOME_HISTORY_CARDS_BASE_IMPORTS = [
  "./home-history-cards-base-layout.css",
...
const EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_IMPORTS = [
  "./project-library-cards-selection-state.css",
...
const EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_SELECTORS = [
  "@import url(\"./project-library-cards-selection-state.css\")",
  "@import url(\"./project-library-cards-selection-check.css\")",
  "@import url(\"./project-library-cards-selection-hover.css\")"
];
const EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_STATE_SELECTORS = [
  ".library-small-card.selected",
  ".library-small-card.is-selectable > button:not(.library-card-check)"
];
const EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_CHECK_SELECTORS = [
  ".library-card-check",
  ".library-small-card.selected .library-card-check"
];
const EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_HOVER_SELECTORS = [
  ".library-small-card > button:not(.library-card-check):hover",
...
const EXPECTED_HOME_RESPONSIVE_MOBILE_SELECTORS = [
  "@import url(\"./home-responsive-mobile-history.css\")",
  "@import url(\"./home-responsive-mobile-community.css\")",
  "@import url(\"./home-responsive-mobile-feed.css\")",
  "@import url(\"./home-responsive-mobile-prompt.css\")"
];
const EXPECTED_HOME_RESPONSIVE_MOBILE_HISTORY_SELECTORS = [
  "@media (max-width: 760px)",
  ".home-stage",
  ".home-history-grid"
];
const EXPECTED_HOME_RESPONSIVE_MOBILE_COMMUNITY_SELECTORS = [
  "@media (max-width: 760px)",
  ".home-community-section",
  ".home-section-head nav"
];
const EXPECTED_HOME_RESPONSIVE_MOBILE_FEED_SELECTORS = [
  "@media (max-width: 760px)",
  ".home-inspiration-grid.feed",
  ".home-masonry-feed"
];
const EXPECTED_HOME_RESPONSIVE_MOBILE_PROMPT_SELECTORS = [
  "@media (max-width: 760px)",
  ".home-prompt",
  ".home-model",
  ".home-model-picker"
...
const EXPECTED_HOME_HISTORY_CARD_BASE_SELECTORS = [
  "@import url(\"./home-history-cards-base-layout.css\")",
  "@import url(\"./home-history-cards-base-shell.css\")",
  "@import url(\"./home-history-cards-base-state.css\")"
];
const EXPECTED_HOME_HISTORY_CARD_BASE_LAYOUT_SELECTORS = [
  ".home-history-grid",
  ".home-history-card"
];
const EXPECTED_HOME_HISTORY_CARD_BASE_SHELL_SELECTORS = [
  ".home-history-card > button:not(.home-history-delete)",
  ".home-history-card.is-create > button:not(.home-history-delete)"
];
const EXPECTED_HOME_HISTORY_CARD_BASE_STATE_SELECTORS = [
  ".home-history-card.is-removing",
...
const EXPECTED_HOME_HISTORY_CARD_PREVIEW_SELECTORS = [
  "@import url(\"./home-history-cards-preview-shell.css\")",
  "@import url(\"./home-history-cards-preview-fallback.css\")",
  "@import url(\"./home-history-cards-preview-image.css\")"
];
const EXPECTED_HOME_HISTORY_CARD_PREVIEW_SHELL_SELECTORS = [
  ".home-history-thumb",
  ".home-history-thumb img"
];
const EXPECTED_HOME_HISTORY_CARD_PREVIEW_FALLBACK_SELECTORS = [
  ".home-history-thumb b,",
  ".project-preview-fallback"
];
const EXPECTED_HOME_HISTORY_CARD_PREVIEW_IMAGE_SELECTORS = [
...
const EXPECTED_NODE_DIRECTOR_TILE_SELECTORS = [
  "@import url(\"./node-director-tile-shell.css\")",
  "@import url(\"./node-director-tile-state.css\")",
  "@import url(\"./node-director-tile-content.css\")"
];
const EXPECTED_NODE_DIRECTOR_TILE_SHELL_SELECTORS = [
  ".director-tile",
  ".director-tile::after"
];
const EXPECTED_NODE_DIRECTOR_TILE_STATE_SELECTORS = [
  ".director-tile:hover",
  ".director-tile:hover::after",
  ".director-tile.running"
];
const EXPECTED_NODE_DIRECTOR_TILE_CONTENT_SELECTORS = [
  ".director-tile small",
  ".director-tile span",
  ".director-tile b"
];
...
const nodeDirectorTileImports = parseCssImports("styles/features/node-director-tile.css");
...
assertListEqual("styles/features/node-director-tile.css", nodeDirectorTileImports, EXPECTED_NODE_DIRECTOR_TILE_IMPORTS);
...
checkImportedFilesExist(nodeDirectorTileImports, "styles/features");
...
checkFileContains("styles/features/home-responsive-mobile-feed.css", EXPECTED_HOME_RESPONSIVE_MOBILE_FEED_SELECTORS);
checkFileContains("styles/features/home-responsive-mobile-prompt.css", EXPECTED_HOME_RESPONSIVE_MOBILE_PROMPT_SELECTORS);
...
checkFileContains("styles/features/home-history-cards-base-layout.css", EXPECTED_HOME_HISTORY_CARD_BASE_LAYOUT_SELECTORS);
...
checkFileContains("styles/features/node-director-tile-shell.css", EXPECTED_NODE_DIRECTOR_TILE_SHELL_SELECTORS);
checkFileContains("styles/features/node-director-tile-state.css", EXPECTED_NODE_DIRECTOR_TILE_STATE_SELECTORS);
checkFileContains("styles/features/node-director-tile-content.css", EXPECTED_NODE_DIRECTOR_TILE_CONTENT_SELECTORS);
...
checkFileContains("styles/features/project-library-cards-selection-state.css", EXPECTED_PROJECT_LIBRARY_CARDS_SELECTION_STATE_SELECTORS);
