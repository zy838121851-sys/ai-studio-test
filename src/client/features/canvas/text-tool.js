...
export function positionTextToolbar({
  ...
  if (fontFamilyInput) {
    fontFamilyInput.value = editor.style.fontFamily || fontFamilyInput.value;
  }
  if (fontWeightInput) {
    fontWeightInput.value = String(parseInt(getComputedStyle(editor).fontWeight, 10) || fontWeightInput.value || 600);
  }
