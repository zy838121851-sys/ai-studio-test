export function createCompatibilityBridge(runtime, options = {}) {
  ...
  const bridge = {
    ...
    setProjectSelectionMode: libraryBindings.setProjectSelectionMode,
    toggleProjectSelection: libraryBindings.toggleProjectSelection,
    toggleAllProjectSelection: libraryBindings.toggleAllProjectSelection,
    deleteSelectedProjects: libraryBindings.deleteSelectedProjects,
